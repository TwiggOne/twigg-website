...
export default function ArchetypesScreen({
  ...
  `}
    ...
    "
      ...
      <div
        className="max-w-[287px] mx-auto rounded-[10px] px-[24px] py-[10px] items-center justify-center text-[#BC9313] font-semibold text-switzer text-[12px] md:text-[14px]   bg-[rgba(188,147,19,0.05)]
 border border-[#BC9313]/60 backdrop-blur-[50px] "
      >
