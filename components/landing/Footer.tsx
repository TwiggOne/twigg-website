...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0D2F23] text-white pt-[100px] px-[100px] relative">
      <div className="w-full flex-col gap-[40px]">
        ...
        <div className="mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 mb-16">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            ...
            <p className="text-gray-300 font-switzer text-sm leading-relaxed">
              Your journey with money doesn't have to be complicated. With
              Twigg, clarity and confidence are just a tap away.
            </p>
          </div>
          <div
            className="lg:col-span-8 grid "
            style={{ gridTemplateColumns: "repeat(3, 1fr) 1.5fr" }}
          >
            {/* Link Groups */}
            {linkGroups.map((group, index) => (
              <div key={index}>
                <h4 className="font-semibold text-white font-bricolage mb-4 text-base">
                  {group.title}
                </h4>
        ...
        <div className=" font-switzer pt-[40px] pb-[120px] flex flex-col md:flex-row justify-between items-center gap-4 text-[14px] text-[#FDF9F0]">
